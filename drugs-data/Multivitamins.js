const multivitaminsData = [
  {
    ...
    drugName: "Apetamin",
    description:
      "Apetamin is a supplement that combines vitamins, amino acids, and the antihistamine cyproheptadine. It is primarily used to stimulate appetite and promote weight gain in individuals who have difficulty gaining weight or suffer from conditions that lead to weight loss. Cyproheptadine increases hunger by blocking certain chemical messengers in the body, while the vitamins and amino acids support overall health and nutrition.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Apetamin0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Apetamin1.webp",
    ],
    inStock: true,
    price: "GHS 56.00",
    uses: [
  ...
  },
  {
    ...
    drugName: "Tres Orix",
    description:
      "Tres Orix is a nutritional supplement designed to stimulate appetite and promote weight gain. It contains a combination of vitamins, amino acids, and the appetite stimulant cyproheptadine. This formulation helps individuals with poor appetite or those needing to gain weight due to various conditions. The vitamins and amino acids support overall health, while cyproheptadine helps increase hunger by influencing certain chemical pathways in the body.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Tres-orix0.png",
      "https://pharmacy-api-1u0w.onrender.com/assets/Tres-orix1.webp",
      "https://pharmacy-api-1u0w.onrender.com/assets/Tres-orix2.webp",
    ],
    inStock: true,
    price: "GHS 63.00",
    uses: [
  ...
  },
  {
    ...
    drugName: "Gudapet",
    description:
      "Gudapet is a nutritional supplement designed to stimulate appetite and support weight gain. It typically contains a blend of vitamins, amino acids, and the antihistamine cyproheptadine, which is known for its appetite-stimulating properties. Gudapet is intended for individuals who struggle with poor appetite or need to gain weight due to various health conditions. The vitamins and amino acids in the supplement also help improve overall health and nutritional status.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Gudapet0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Gudapet1.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Gudapet2.jpg",
    ],
    inStock: true,
    price: "GHS 23.00",
    uses: [
  ...
  },
  {
    ...
    drugName: "Zincovit",
    description:
      "Zincovit is a comprehensive multivitamin and multimineral supplement designed to support overall health and well-being. It contains a balanced blend of vitamins, minerals, and trace elements, including zinc, which plays a crucial role in immune function and wound healing. Zincovit is often used to address nutritional deficiencies, boost immunity, and improve overall health, particularly in individuals with increased nutritional needs or those recovering from illness.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Zincovit0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Zincovit1.webp",
      "https://pharmacy-api-1u0w.onrender.com/assets/Zincovit2.webp",
    ],
    inStock: true,
    price: "GHS 60.00",
    uses: [
