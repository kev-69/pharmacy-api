const stomachUpsetsData = [
  {
    ...
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Nugel0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Nugel1.jpeg",
    ],
    inStock: true,
    price: "GHS 70.00",
    uses: [
  ...
  },
  {
    ...
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Magacid0.avif",
      "https://pharmacy-api-1u0w.onrender.com/assets/Magacid1.webp",
      "https://pharmacy-api-1u0w.onrender.com/assets/Magacid2.jpg",
    ],
    inStock: true,
    price: "GHS 23.00",
    uses: [
  ...
  },
  {
    ...
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Gastrogen0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Gastrogen1.jpg",
    ],
    inStock: true,
    price: "GHS 25.00",
    uses: [
  ...
  },
  {
    ...
    drugName: "Omeprazol",
    description:
      "Omeprazole is a proton pump inhibitor (PPI) used to treat various conditions related to excess stomach acid. It works by inhibiting the proton pumps in the stomach lining, which reduces the production of stomach acid. This helps alleviate symptoms associated with acid-related disorders, including heartburn, gastroesophageal reflux disease (GERD), and peptic ulcers.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Omeprazol0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Omeprazol1.png",
    ],
    inStock: true,
    price: "GHS 6.00",
    uses: [
