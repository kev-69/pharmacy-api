const herbalDrugsData = [
  {
    ...
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Rooter0.png",
      "https://pharmacy-api-1u0w.onrender.com/assets/Rooter1.png",
    ],
    inStock: true,
    price: "GHS 40.00",
    uses: [
  ...
  },
  {
    ...
    description:
      "Tabea Herbal Mixture is a natural supplement designed to provide overall health support through a blend of herbal ingredients. It typically combines herbs known for their beneficial effects on various bodily systems, including digestive health, immune support, and general well-being. The specific formulation can vary, but it usually aims to leverage the therapeutic properties of multiple herbs for holistic health benefits.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Tabea0.jpg",
      "https://pharmacy-api-1u0w.onrender.com/assets/Tabea1.webp",
      "https://pharmacy-api-1u0w.onrender.com/assets/Tabea2.webp",
    ],
    inStock: true,
    price: "GHS 32.00",
    uses: [
  ...
  },
  {
    ...
    description:
      "Mighty Power is a dietary supplement formulated to support overall health and enhance physical performance. It typically contains a blend of vitamins, minerals, and herbal ingredients designed to boost energy, stamina, and vitality. The supplement is aimed at improving general well-being, increasing endurance, and supporting overall health.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Mighty0.png",
      "https://pharmacy-api-1u0w.onrender.com/assets/Mighty1.jpg",
    ],
    inStock: true,
    price: "GHS 40.00",
    uses: [
  ...
  },
  {
    ...
    description:
      "Masada Mixture is a herbal supplement designed to promote overall health and well-being through a combination of natural ingredients. It typically includes a variety of herbs known for their beneficial effects on physical and mental health. The formulation aims to support various bodily systems, enhance vitality, and improve general wellness.",
    images: [
      "https://pharmacy-api-1u0w.onrender.com/assets/Masada0.png",
      "https://pharmacy-api-1u0w.onrender.com/assets/Masada1.png",
    ],
    inStock: true,
    price: "GHS 25.00",
    uses: [
